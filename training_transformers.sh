...
for seed in {0..4}; do
    python new_main_tr.py -MHC --epochs 100 --train --seed $seed --save_data --use_mlp_baseline --model_prefix lstm
done

for seed in {0..4}; do
    python new_main_tr.py -MHo --epochs 100 --train --seed $seed --save_data --use_mlp_baseline --model_prefix lstm
done