...
for seed in 0 1 2 3 4; do
    python new_main_tr.py -MHC --epochs 100 --train  --seed $seed --save_data --use_mlp_baseline --model_prefix db --info_weight 1.0 --dim_weight 1.0 --recon_weight 1.0
done

for seed in 0 1 2 3 4; do
    python new_main_tr.py -MHo --epochs 100 --train  --seed $seed --save_data --use_mlp_baseline --model_prefix db --info_weight 1.0 --dim_weight 1.0 --recon_weight 1.0
done