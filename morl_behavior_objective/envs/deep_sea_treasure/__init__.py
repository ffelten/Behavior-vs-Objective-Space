...
from morl_behavior_objective.envs.deep_sea_treasure.deep_sea_treasure import LEFT_RIGHT_DST_MAP, SMOOTH_MAP, LOUVRE_DST_MAP
...
register(
    id="deep-sea-treasure-louvre-dst-v0",
    entry_point="morl_behavior_objective.envs.deep_sea_treasure.deep_sea_treasure:DeepSeaTreasure",
    max_episode_steps=100,
    kwargs={"dst_map": LOUVRE_DST_MAP},
)
