...
def main():
    ...
    emb_dim =  12 if args.Traj2d else 32 if args.Reacherv4 else 32 if args.Pusherv4 else 32 if args.Walker2dv4 else 64 if args.Humanoidv4 else 4 if args.DeepSeaTreasure else 4
    cnn_output_dim = emb_dim

    num_heads = 4 if args.Traj2d else 4 if args.Reacherv4 else 4 if args.Pusherv4 else 4 if args.Walker2dv4 else 4 if args.Humanoidv4 else 1 if args.DeepSeaTreasure else 4
    ...
    config_name = f"emb_dim_{emb_dim}_max_len_{seq_max_len}_seed_{SEED}_ratio_{ratio}_strategy_{embedding_strategy_code}_training_{training_code}"
    ...
    if args.Traj2d or args.Reacherv4 or args.Pusherv4 or args.DeepSeaTreasure:
        color_label_mapping = {
                "tab:blue": "Mode 0",
                "tab:red": "Mode 1",
                "tab:green": "Mode 2",
